import MongooseUserRepository from '../../infrastructure/persistence/mongoose/user/mongooseUserRepository.js';
...
export const registerUser = new RegisterUser(repo, hasher,tokenProvider);
